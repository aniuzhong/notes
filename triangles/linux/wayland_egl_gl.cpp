...
int main() {
    ...
    libdecor_frame_set_title(decor_frame, "Wayland-EGL-GL Window");
    libdecor_frame_set_app_id(decor_frame, "org.example.wayland-egl-gl");
    ...
    if (!init_egl_gl()) return EXIT_FAILURE;
